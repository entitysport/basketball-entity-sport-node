...
class API {
    constructor(options) {
      this.base_url = 'https://rest.entitysport.com/basketball/';
...
class Entity_basketball
{
    ...
    addResources() {
        Object.assign(this, {
          basketball : require('./get_all_functions.js')(this.api),
        })
    }
}

module.exports = Entity_basketball
